...
CI_CR=function(B)
{
      RI=c(0,0,0.58,0.90,1.12,1.24,1.32,1.41,1.45,1.49,1.51)#RIֵ??Ϊ????
	Wi=weight(B);
	n=length(Wi);
	if(n>2)
	{
...
z_score=function(B,converse=FALSE)  #converseΪT??TRUEʱ??????????ָ?꣬Ĭ??ΪF
{
   B=as.vector(B);
